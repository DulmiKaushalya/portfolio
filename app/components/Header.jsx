    ...
    items-center justify-center gap-4'>
      ...
      className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>
            ...
            className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'> 
                Software Developer based in Sri Lanka</motion.h1>
                < motion.p
                initial={{opacity:0}}
                whileInView={{opacity:1}}
                transition={{duration:0.6 ,delay:0.7 }}>Software Engineering Undergraduate | Full Stack Developer | Mobile App Enthusiast    
                </motion.p>
                <div className='flex flex-col sm:flex-row items-center gap-4 mt-4 '>
                    ...
                    href='/Kaushalya P.L.P.D.pdf' download  className='px-10 py-3 border rounded-full border-gray-500 flex
